...
exports.randomMenu = (prefix, botName) => {
    return `꒰ ᐢ⸝⸝•༝•⸝⸝ᐢ ꒱ ֺ *「 RANDOM MENU 」* ˎˊ˗
˗ˏˋ🧺 ៵ ࣪  *${prefix}quotes*
˗ˏˋ🧺 ៵ ࣪  *${prefix}darkjokes
˗ˏˋ🧺 ៵ ࣪  *${prefix}pantun
˗ˏˋ🧺 ៵ ࣪  *${prefix}bucin
˗ˏˋ🧺 ៵ ࣪  *${prefix}cehor
˗ˏˋ🧺 ៵ ࣪  *${prefix}katabijak
˗ˏˋ🧺 ៵ ࣪  *${prefix}fakta
˗ˏˋ🧺 ៵ ࣪  *${prefix}motivasi
𒀭ᥫ᭡ *「 ${botName} 」* Ꮺ ָ࣪ ۰ .`
}
